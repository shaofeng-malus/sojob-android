...
public final class DateUtil {
	 ...
	 * @return
	 */
	public static String getStringDateFromMilliseconds2(long milliseconds) {
		if (milliseconds == 0) {
			return "";
		}
		...
		String string;
		Date date = new Date(milliseconds);
		string = new SimpleDateFormat("yyyy年MM月dd日").format(date);
		return string;
	}
	...
	public static String TimeStamp2Date(String timestampString) {
		...
		try {
			...
			date = new SimpleDateFormat("MM-dd HH:mm").format(timestamp);
		} catch (Exception e) {
			date = "";
		}
		return date;
	...
	public static String TimeStamp2Date2(String timestampString) {
		...
		try {
			Long timestamp = Long.parseLong(timestampString) * 1000;
			date = new SimpleDateFormat("yyyy年MM月dd日").format(timestamp);
		} catch (Exception e) {
			date = "";
		}
		return date;
